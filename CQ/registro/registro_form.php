...
function verifica(){
	...
	if(campo.data.value == "0"){
		alert('Campo Data não pode ser vazio');
		campo.data.focus()
		return false
		}
	if(campo.setor.value == "0"){
		alert('Campo Setor não pode ser vazio');
		campo.setor.focus()
		return false
		}
	if(campo.agente.value == "0"){
		alert('Campo agente não pode ser vazio');
		campo.agente.focus()
		return false
		}
	if(campo.agente.value == "0"){
	...
	if(campo.avaliacao.value == "0"){
		alert('Campo avaliacao não pode ser vazio');
		campo.avaliacao.focus()
		return false
		}
	if(campo.categoria.value == "0"){
		alert('Campo Categoria não pode ser vazio');
		campo.categoria.focus()
		return false
		}
	if(campo.sub.value == "0"){
		alert('Campo Sub-Categoria não pode ser vazio');
		campo.sub.focus()
		return false
		}
	if(campo.item.value == "0"){
		alert('Campo Item não pode ser vazio');
		campo.item.focus()
		return false
		}
