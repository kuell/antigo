...
<body>
<div class="acao_pagina">Digitação do Controle de Faturamento</div>
...
<table border="0" align="center" class="KT_tngtable">
  ...
  <tr>
    ...
    <div class="div_botoes"><label>
      <input name="Button" type="button" onclick="abre('fat_produto.php')" value="Buscar"/>
    </label>
      <label>
        <input name="Button" type="button" onclick="abre('fatVisualizarr.php')" value="Visualizar"/>
      </label>
    </div></th>
  </tr>
</table>
