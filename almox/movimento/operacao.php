...
<tbody>
	...
	<form name="<?php echo $grupo->id;?>">
		...
		<td><input type="text" class="form-control" value="<?php echo $valor->qtdDevEntrada;?>" name="qtd"></td>
		<td><input type="text" class="form-control" value="<?php echo $valor->valorDevEntrada;?>" name="valor"></td>
		<td>
	...
	<form name="<?php echo $grupo->id;?>">
		<td>Saida</td>
		<td><input type="text" class="form-control" value="<?php echo $valor->qtdSaida;?>" name="qtd"></td>
		<td><input type="text" class="form-control" value="<?php echo $valor->valorSaida;?>" name="valor"></td>
		<td>
	...
	<form name="<?php echo $grupo->id;?>">
		...
		<td><input type="text" class="form-control" value="<?php echo $valor->qtdDevSaida;?>" name="qtd"></td>
		<td><input type="text" class="form-control" value="<?php echo $valor->valorDevSaida;?>" name="valor"></td>
		<td>
	...
	<form name="<?php echo $grupo->id;?>">
		...
		<td><input type="text" class="form-control" value="<?php echo $valor->qtdCtf;?>" name="qtd"></td>
		<td><input type="text" class="form-control" value="<?php echo $valor->valorCtf;?>" name="valor"></td>
		<td>
