...
<div class="acao_pagina" align="center">Classifica&ccedil;&atilde;o de Ordem Externa</div><br />
  ...
  <tr>
  	<td colspan="10">Não existem ordens de serviço para serem classificadas</td>
  </tr>
  <?php }else{?>
  <?php do { ?>
    <tr>
      ...
      <td>
      <a href="mov_orcamento.php?id_OSE=<?php echo $row_rs_ordem['id_OSE']; ?>" rel="superbox[iframe][700x500]" title="Digitação/Manutenção do Orçamento!"><img src="../../img/classificar.png" alt="" width="16" height="16" border="0" /></a>
     </td>
      <?php }else{?>
      <td>
