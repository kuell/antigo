...
function pergunta(id){
	if(confirm("Deseja EXCLUIR a Ordem No."+id+"?")){
		location.href = "funcao.php?acao=excluir&amp;id_ose="+id;
		}
		return false
	}
...
<table width="600px" border="0" align="center" class="KT_tngtable">
  <tr>
    <th scope="col" width="10px">Cod</th>
  ...
  <?php do { ?>
    <tr>
      ...
      <td width="10px"><?php echo $row_ordem['data_envio']; ?></td>
      ...
      <td><a href="mov_form.php?id_OSE=<?php echo $row_ordem['id_OSE']; ?>"><img src="../../relatorio/images/edit.png" alt="" width="16" height="16" border="0" title="Editar OS" /></a></td>
      <td><a href="#"><img src="../../relatorio/images/print.gif" alt="" width="16" height="16" border="0" onclick="MM_openBrWindow('../relatorio/recibo_ose/php/recibo.php?descricao=<?php echo $row_ordem['id_OSE']; ?>','Print','width=800,height=600')" title="Imprimir OS" /></a><a href="#" onclick="pergunta(<?php echo $row_ordem['id_OSE']; ?>)"></a></td>
           <td><a href="#" onclick="pergunta(<?php echo $row_ordem['id_OSE']; ?>)"><img src="../../CQ/images/Delete.png" alt="" width="16" height="16" border="0" title="Excluir OS" /></a><a href="../relatorio/recibo_ose/php/recibo.php?descricao=<?php echo $row_ordem['id_OSE']; ?>" rel="superbox[iframe][700x500]"></a></td>
    </tr>
    <tr>
