...
<br />
<table width="auto" border="0" align="center" class="KT_tngtable" style="border:#000">
  <tr class="div_botoes">
    <th>Setor</th>
    <th>Registros</th>
    <th>Part. Registro</th>
  ...
  <?php do { ?>
    <tr bordercolor="#000000" style="font:10px Verdana, Geneva, sans-serif;">
      <td><a href="../../relatorios/ose/report_1.php?setor=<?php echo $row_rs_ordem['setor']; ?>"><?php echo $row_rs_ordem['setor']; ?></a></td>
...
<div id="print" align="center"><button>Imprimir</button></div>
<p>&nbsp;</p>
</body>
</html>
<?php
