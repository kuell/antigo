...
<input type="button" value="Visualizar" onclick="ieExecWB(7)" />
</head>
<body bgcolor="#CCCCCC">
<table width="auto" height="auto" border="0" align="center" bgcolor="#FFFFFF" class="KT_tngtable">
  <tr align="left" class="hasevent_cal">
    <th width="auto" height="16" scope="col">Cod</th>
    <th width="auto" scope="col">Data envio</th>
    <th width="auto" scope="col">Equipamento</th>
    <th width="auto" scope="col">Setor</th>
    <th width="auto" scope="col">Requisitante</th>
    <th width="auto" scope="col">Status</th>
    <th width="auto" scope="col">Valor</th>
  </tr>
  <?php do { ?>
    <tr style="text-align:left; font-size:9px; font-family:Verdana, Geneva, sans-serif; border-top: medium">
      ...
      <td><?php echo $row_rs_ordem['preco_servico']; ?></td>
    </tr>
    <?php } while ($row_rs_ordem = mysql_fetch_assoc($rs_ordem)); ?>
<tr class="MXW_disabled">
  <th height="26" colspan="9" align="right"> Total = R$    <?php echo $row_Recordset1['SUM(preco_servico)']; ?></th></tr>
