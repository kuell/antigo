	...
	group by 	
      ...
      $fill=1;
	   while ($res=mysql_fetch_array($qr)) {
        ...
        $this->Cell($w[3],4,('R$ '.(number_format($res["custo_setor"], 2, ",", "."))),"LRBT",0,"R",$fill);
		$this->Cell($w[4],4,((round($res["part_setor"], 2)).' %'),"LRBT",0,"C",$fill);
	  ...
	  $this->Ln();
	  $this->Cell($w[0],4,"Total Custo = ","TLRB",0,"R");
