...
function n(){
    if(!i.superbox.elementsReady){
        ...
        a=i('<p class="close btn" onclick="location.reload()"><a><strong><span>'+w.closeTxt+"</span></strong></a></p>").prependTo(q).find("a");
        p=i('<p class="span2 alert-success alert offset6">'+w.loadTxt+"</p>").appendTo(r).hide();
